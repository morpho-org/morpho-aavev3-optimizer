...
contract TestIntegrationSupplyVault is TestSetupVaults {
    ...
    function testShouldRedeemAllAmountWhenMorphoPoolIndexesOutdated(uint256 amount, uint256 timePassed) public {
        ...
        uint256 totalBalanceBefore = morpho.scaledPoolSupplyBalance(address(dai), address(daiSupplyVault));
        ...
        uint256 totalBalanceAfter = morpho.scaledPoolSupplyBalance(address(dai), address(daiSupplyVault));
    ...
    function testShouldWithdrawAllAmountWhenMorphoPoolIndexesOutdated(uint256 amount, uint256 timePassed) public {
        ...
        uint256 totalBalanceBefore = morpho.scaledPoolSupplyBalance(dai, address(daiSupplyVault));
        ...
        uint256 totalBalanceAfter = morpho.scaledPoolSupplyBalance(dai, address(daiSupplyVault));
