...
library MarketLib {
    ...
    function setIsDeprecated(Types.Market storage market, address underlying, bool newIsDeprecated) internal {
        market.pauseStatuses.isDeprecated = newIsDeprecated;

        emit Events.IsDeprecatedSet(underlying, newIsDeprecated);
    }

    function setIsP2PDisabled(Types.Market storage market, address underlying, bool newIsP2PDisabled) internal {
        market.pauseStatuses.isP2PDisabled = newIsP2PDisabled;

        emit Events.IsP2PDisabledSet(underlying, newIsP2PDisabled);
    }
